<template>
  <v-data-table :headers="headers" :items="locais" sort-by="calories" class="elevation-1">
    <template v-slot:top>
      <v-toolbar flat>
          ...
          <v-card>
            ...
            <v-card-text>
              <v-container>
                <v-row>
                  <v-col cols="12">
                    <v-text-field v-model="editedItem.nome" label="Nome do Local"></v-text-field>
                  </v-col>
                  <v-col cols="12">
                    <v-text-field v-model="editedItem.descricao" label="Descrição do Local"></v-text-field>
                  </v-col>
                  <v-col cols="12">
                    <v-text-field v-model="editedItem.capacidade" label="Capacidade do Local"></v-text-field>
                  </v-col>
                </v-row>
              </v-container>
            </v-card-text>
...
const service = LocalService.build();
    ...
    save() {
      if (this.editedIndex > -1) {
        service
          ...
          .then(Object.assign(this.locais[this.editedIndex], this.editedItem));
      } else {
        service
